(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.screenData = factory(global.React));
    ...
    ***************************************************************************** */
    ...
    var f = "undefined" != typeof process && void 0 !== process.env && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled",
      ...
      P = function (t, n) {
        if ("production" !== process.env.NODE_ENV) {
          var o$1 = n ? ' with the id of "'.concat(n, '"') : "",
            s = "The component ".concat(t).concat(o$1, " has been created dynamically.\n") + "You may see this warning because you've called styled inside another component.\nTo resolve this only create new StyledComponents outside of any render method and function component.",
            i = console.error;
          try {
            var a = !0;
    ...
    var qe = function (e) {
      ...
      He = function (t) {
        ...
        for (var s in t) {
          var i = t[s];
          t.hasOwnProperty(s) && !qe(i) && (Array.isArray(i) && i.isCss || re(i) ? r.push("".concat(We(s), ":"), i, ";") : ce(i) ? r.push.apply(r, __spreadArray(__spreadArray(["".concat(s, " {")], He(i), !1), ["}"], !1)) : r.push("".concat(We(s), ": ").concat((n = s, null == (o = i) || "boolean" == typeof o || "" === o ? "" : "number" != typeof o || 0 === o || n in unitlessKeys || n.startsWith("--") ? String(o).trim() : "".concat(o, "px")), ";")));
        }
        return r;
      };
    function Ue(e, t, n, o) {
    ...
    function rt(e, r, s) {
      ...
      function O(e, r) {
        return function (e, r, s) {
          ...
          "production" !== process.env.NODE_ENV && o.useDebugValue(d);
          var v = I(r, f, c) || C,
            g = function (e, n, o) {
          ...
          var E = function (e, t) {
            var n = Be(),
              o$1 = e.generateAndInjectStyles(t, n.styleSheet, n.stylis);
          ...
          var N = ie(p, d);
          return E && (N += " " + E), g.className && (N += " " + g.className), w[L(S) && !A.has(S) ? "class" : "className"] = N, w.ref = s, o.createElement(S, w);
        }(D, e, r);
      }
      O.displayName = y;
    ...
    //样式
    var Container = ut.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: fixed;\n  top: 0;\n  left: 0;\n  overflow: hidden;\n  z-index: 999;\n  transform-origin: left top;\n  border: 1px solid red;\n  box-sizing: border-box;\n"], ["\n  position: fixed;\n  top: 0;\n  left: 0;\n  overflow: hidden;\n  z-index: 999;\n  transform-origin: left top;\n  border: 1px solid red;\n  box-sizing: border-box;\n"])));
    var ReactScreenBox = function (props) {
        //组件参数
        var screenBoxRef = o.useRef(null);
        var setWidth = 0;
        var setHeight = 0;
        var originalWidth = 0;
        var originalHeight = 0;
        var observer = null;
        var _a = o.useState(false), ready = _a[0], setReady = _a[1];
        ...
        var initSize = function () {
            return new Promise(function (resolve) {
                var _a, _b;
                //获取大屏的真实尺寸
                setWidth = (_a = props.width) !== null && _a !== void 0 ? _a : 1920;
                setHeight = (_b = props.height) !== null && _b !== void 0 ? _b : 1080;
                //获取大屏画布尺寸
        ...
        var updateSize = function () {
            if (screenBoxRef.current && setWidth && setHeight) {
                screenBoxRef.current.style.width = "".concat(setWidth, "px");
                screenBoxRef.current.style.height = "".concat(setHeight, "px");
            }
        };
        //更新缩放
        var updateScale = function () {
            ...
            //获取大屏最终的尺寸
            var realWidth = setWidth || originalWidth;
            var realHeight = setHeight || originalHeight;
            var widthScale = currentWidth / realWidth;
            var heightScale = currentHeight / realHeight;
            if (screenBoxRef.current) {
                screenBoxRef.current.style.transform = "scale(".concat(widthScale, ",").concat(heightScale, ")");
            }
        };
        //监听尺寸的回调函数(初始化尺寸, 更新缩放)
        var onResize = function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, initSize()];
                    case 1:
                        _a.sent();
                        updateScale();
                        return [2 /*return*/];
        ...
        //浏览器移除监听dom元素
        var removeMutationObserver = function () {
            if (observer) {
                observer.disconnect();
            }
        };
        ...
        return (o.createElement(Container, { ref: screenBoxRef }, ready ? props.children : o.createElement(o.Fragment, null)));
    };
    var templateObject_1;

    return ReactScreenBox;
